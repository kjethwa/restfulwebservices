...
insert into user_details(user_id,full_name,login_id,password,phone_number,status) values('64f2ab89-141d-4cd5-8bd7-f1fac3b18c31','Kajal Devaliya','kajaldev28@gmail.com','$2a$10$tZIXnqfNOX5hdtwLUfHm9u4CjbryhUNV1oKgWAv59FglMjMG/75/q',8286822206,'ACTIVE');
...
insert into user_details(user_id,full_name,login_id,password,phone_number,status) values('64f2ab89-141d-4cd5-8bd7-f1fac3b18c33','Nikesh Jethwa','nikeshjethwa21@gmail.com','$2a$10$tZIXnqfNOX5hdtwLUfHm9u4CjbryhUNV1oKgWAv59FglMjMG/75/q',8898234546,'ACTIVE');
